                        ...
                        <table id="recruiterTable">
                            ...
                            <tbody>
                                <?php foreach ($data['transactions'] as $transaction) : ?>
                                    <tr class="table-row" data-url="<?php echo URLROOT . '/recruiters/public_profile/' . $transaction->id ?>">
                                        <td> <?php echo $transaction->name ?></td>
                                        <td><?php echo $transaction->business_name ?></td>
                                        <td><a class="download-btn" role="button" href="<?php echo URLROOT . '/assets/brs/' . $transaction->br_path ?>" target="_blank">Download</a> </td>
                                        <td><?php echo time_elapsed_string($transaction->application_date) ?></td>
                                        <td>
                                        ...
                                        <!-- <td>
                                            <?php if ($transaction->is_varified == 1) : ?>
